...
def delete_entry(entryid):
	...
	return jsonify({'message': 'Your entry has been successfully deleted'})
...
def modify_entry():
	...
	entry=request.get_json()['entry']
	username=request.get_json()['username']
	cur.execute("UPDATE entries SET username WHERE entryid='"+str(entryid)+"'")
	conn.commit()
	return jsonify({'message': 'Your entry has been modified'})
